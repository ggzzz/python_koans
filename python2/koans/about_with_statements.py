...
class AboutWithStatements(Koan):
    ...
    def test_counting_lines(self):
        self.assertEqual(4, self.count_lines("D:/example_file.txt"))
    ...
    def test_finding_lines(self):
        self.assertEqual('test\n', self.find_line("D:/example_file.txt"))
    ...
    def test_counting_lines2(self):
        self.assertEqual(4, self.count_lines2("D:/example_file.txt"))
    ...
    def test_finding_lines2(self):
        self.assertEqual('test\n', self.find_line2("D:/example_file.txt"))
        self.assertNotEqual(None, self.find_line2("D:/example_file.txt"))
    ...
    def test_open_already_has_its_own_built_in_context_manager(self):
        self.assertEqual(4, self.count_lines3("D:/example_file.txt"))
